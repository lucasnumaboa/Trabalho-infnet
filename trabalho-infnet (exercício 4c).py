...
cv_acc = cross_val_score(modelo_dt, X_train, y_train, cv=skf, scoring='accuracy')
cv_precision = cross_val_score(modelo_dt, X_train, y_train, cv=skf, scoring='precision_weighted')
cv_recall = cross_val_score(modelo_dt, X_train, y_train, cv=skf, scoring='recall_weighted')
cv_f1 = cross_val_score(modelo_dt, X_train, y_train, cv=skf, scoring='f1_weighted')
